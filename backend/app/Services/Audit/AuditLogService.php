...
class AuditLogService
{
    ...
    public function list(array $filters, int $page, int $pageSize): array
    {
        ...
        $riskActions = ['admin.create', 'ledger_adjustment.create', 'ledger_adjustment.succeeded', 'ledger_adjustment.voided', 'ledger_adjustment.exception', 'operation_expense.create', 'reconcile.run'];
